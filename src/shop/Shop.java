...
public class Shop implements Values {
    ...
    public Shop() {
        ...
        shopButtons.add(new ShopButton(new EnchantedRose()));
        shopButtons.add(new ShopButton(new CharredWand()));
        shopButtons.add(new ShopButton(new Sparkler()));
        shopButtons.add(new ShopButton(new ColdSpoon()));
        shopButtons.add(new ShopButton(new SnowyShovel()));
        ...
        shopButtons.add(new ShopButton(new Hydrocto()));
        shopButtons.add(new ShopButton(new Terrapotter()));
